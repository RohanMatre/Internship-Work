...
const Hero = ({ slice }: HeroProps): JSX.Element => {
  ...
  const handleDownloadResume = () => {
    const resumeUrl = slice.primary.resume.url;
  ...
  return (
    ...
    >
      <div className="grid min-h-[70vh] grid-cols-1 md:grid-cols-2 items-center">
        <Shapes />
        <div className="col-start-1 md:row-start-1 text-center md:text-left">
          <h1
          ...
          <span className="job-title block bg-gradient-to-tr from-purple-500 via-teal-300 to-red-600 bg-clip-text text-2xl font-bold uppercase tracking-[.2em] text-transparent opacity-0 mid:text-4xl">
