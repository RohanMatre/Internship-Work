...
interface BlogPostDocumentData {
  ...
  /**
   * Medium field in *Blog Post*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: blog_post.medium
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  medium: prismic.LinkField;
...
interface HomepageDocumentData {
  ...
  /**
   * Resume field in *Homepage*
   *
   * - **Field Type**: Link to Media
   * - **Placeholder**: *None*
   * - **API ID Path**: homepage.resume
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
interface ProjectDocumentData {
  ...
  /**
   * Live field in *Project*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: project.live
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  ...
  /**
   * Youtube field in *Project*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: project.youtube
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface ExperienceSliceDefaultPrimaryExperienceItem {
  ...
  /**
   * Image field in *Experience → Default → Primary → experience*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.experience[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
